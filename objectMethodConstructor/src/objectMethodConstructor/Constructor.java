...
public A(double d,double n) {  //call using A obj=new A(5.5,6)
	num1=d;
	num2=n;
}
public A(int i,int j,int result) {
...
public class Constructor {
	...
	public static void main(String[] args) {
		A obj=new A(5); //as soon as we type new A();        //here we are calling a constructor which we do not 
		...
		System.out.println(obj.num1+obj.num2+obj.result);              //memory.If we need a constructor for example ,one that assigns value
